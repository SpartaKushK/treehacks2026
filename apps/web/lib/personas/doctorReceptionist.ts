import type { TriageRequest } from "@people/shared";

export function buildDoctorReceptionistPrompt(req: TriageRequest): string {
  return `You are a Doctor's Receptionist Agent for Dr. Smith's clinic.
...
- Urgency: ${req.urgency}
- Message: ${req.message}
- Anomaly flags: ${req.anomaly.flags.join(", ")}
